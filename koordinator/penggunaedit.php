        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item"><a href="penggunalihat.php?id=<?php echo $idpengguna; ?>">Detail Pengguna</a></li>
                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary" name="updatepengguna">Simpan Perubahan</button>
                            </div>
                        </form>
                    </div>
                </div>
