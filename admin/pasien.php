...
<style>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        table.addEventListener('click', function (event) {
            // Cek jika klik terjadi pada elemen dengan class 'btn'
            if (event.target.closest('.btn')) {
                return; // Jangan lakukan apa pun jika tombol diklik
            }
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" 
                                data-bs-toggle="tooltip" title="Tambah Data Pasien">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($ambildatakoor)) {
                                    ...
                                    <tr data-id="<?php echo $id; ?>">
                                        ...
                                        <td>
                                            <div>
                                                <a href="pasienhapus.php?id=<?php echo $id; ?>" 
                                    ...
                                    <td>
                                        <div class="mb-3">
                                            ...
                                            <select name="asalfasyankes" class="form-control" id="asalfasyankes">
                                                ...
                                                <?php
                                                $ambilasalfasyankes = mysqli_query($conn, "SELECT * FROM puskesmas");
