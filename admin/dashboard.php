...
.card-body {
    ...
    #map {
        height: 350px; /* Tinggi disetarakan dengan dua grafik */
        width: 100%;
        border-radius: 15px;
        overflow: hidden;
    }
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <!-- Row untuk card baru dan peta -->
                            <div class="row">
                                <!-- Card di atas peta -->
                                <div class="col-md-6">
                                    <div class="card" style="height: 200px;" data-bs-toggle="tooltip" title="Selamat datang di aplikasi APP-SIDBD!">
                                        <!-- Tinggi bisa diatur manual -->
                                        <div class="card-header">SELAMAT DATANG</div>
                                        <div class="card-body">
                                            <p>Aplikasi Sistem Informasi Demam Berdarah (APP-SIDBD) merupakan sebuah sistem.</p>
                                        </div>
                                    </div>
                                    <br>
                                    <!-- Peta -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card mt-3" data-bs-toggle="tooltip" title="Grafik data pengendalian vektor">
                                                ...
                                                <div class="card-body">
                                                    <div class="chart-wrapper">
                                                        <canvas id="myVektorChart" style="height: 300px;"></canvas> <!-- Grafik garis -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
