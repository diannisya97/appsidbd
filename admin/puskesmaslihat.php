            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <a href="puskesmasedit.php?id=<?php echo $data['idpuskesmas']; ?>" class="btn btn-sm btn-success" data-bs-toggle="tooltip" title="Edit Data"> <i class="fas fa-edit" style="color: #fff;"></i> Edit Data</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
