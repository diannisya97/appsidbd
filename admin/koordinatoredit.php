                        ...
                        <div class="card-body">
                            <form method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="asalfasyankes" name="asalfasyankes" class="form-select" required>
                                        <?php
                                        // Fetch puskesmas list for the dropdown
                                        $puskesmasQuery = "SELECT idpuskesmas, Nama_Puskesmas FROM puskesmas ORDER BY Nama_Puskesmas ASC";
                                        $resultPuskesmas = $conn->query($puskesmasQuery);
                                        while ($row = $resultPuskesmas->fetch_assoc()) {
                                            $selected = ($row['idpuskesmas'] == $data['asalfasyankes']) ? 'selected' : '';
                                            echo "<option value='{$row['idpuskesmas']}' $selected>{$row['Nama_Puskesmas']}</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
