                    ...
                    <div class="card-body">
                        <table id="datatablesSimple" data-bs-toggle="tooltip" title="Klik untuk melihat detail data">
                            ...
                            <tr data-id="<?php echo $id; ?>">
                                ...
                                <td>
                                    <div>
                                        <a href="puskesmasdelete.php?id=<?php echo $row['idpuskesmas'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');" data-bs-toggle="tooltip" title="Hapus Data"><i class="fas fa-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php
                ...
                <div class="modal-body">
                    ...
                    <div id="step3" style="display: none;">
                        <div class="row">
                            ...
                            <!-- Kolom untuk Peta -->
                            <div class="col-md-6">
                                <div id="mapid" style="height: 400px;" data-bs-toggle="tooltip" title="Klik Lokasi Yang Sesuai Pada Peta"></div>
                            </div>
                        </div>
                        <div class="modal-footer">
