                        ...
                        <div class="card-body">
                            <table id="datatablesSimple" data-bs-toggle="tooltip" title="Klik untuk melihat detail data">
                                ...
                                <tbody>
                                    <?php
                                    $i = 1;
                                    $ambildatakoor = mysqli_query($conn, "SELECT u.*, p.Nama_Puskesmas FROM koordinator u JOIN puskesmas p ON p.idpuskesmas = u.asalfasyankes");
            ...
            <form method="post"  onsubmit="return validateKoordinatorForm()">
                <div class="modal-body">
                    ...
                    <select id="asalfasyankes" name="asalfasyankes" class="form-control">
                        ...
                        <?php
                        $result = mysqli_query($conn, "SELECT idpuskesmas, Nama_Puskesmas FROM puskesmas");
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo '<option value="' . $row['idpuskesmas'] . '">' . $row['Nama_Puskesmas'] . '</option>';
                        }
                        ?>
                    </select><br>
                </div>
