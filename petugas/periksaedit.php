            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <li class="breadcrumb-item"><a href="dashboard.php" data-bs-toggle="tooltip" title="Dashboard">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="periksa.php" data-bs-toggle="tooltip" title="Ke Halaman Data Pemeriksaan">Data Pemeriksaan</a></li>
                        ...
                        <div class="form-category">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="namars" class="form-control" value="<?php echo $row['namars']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="tanggalmasuk">Tanggal Rawat Inap:</label>
                                    <input type="date" name="tanggalmasuk" class="form-control" value="<?php echo $row['tanggalmasuk']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="ruangrawat">Ruang Rawat:</label>
                                    <input type="text" name="ruangrawat" class="form-control" value="<?php echo $row['ruangrawat']; ?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="namarssebelum">Nama RS Sebelum:</label>
                                    <input type="text" name="namarssebelum" class="form-control" value="<?php echo $row['namarssebelum']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="statuspasienakhir">Status Pasien Keluar:</label>
                                    <input type="text" name="statuspasienakhir" class="form-control" value="<?php echo $row['statuspasienakhir']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="periksajentik">Periksa Jentik:</label>
                                    <input type="text" name="periksajentik" class="form-control" value="<?php echo $row['periksajentik']; ?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
