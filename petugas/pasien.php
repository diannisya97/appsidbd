                        ...
                        <table id="datatablesSimple" data-bs-toggle="tooltip" title="Klik untuk melihat detail pasien">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <a href="pasienhapus.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus Pasien ini?');" data-bs-toggle="tooltip" 
