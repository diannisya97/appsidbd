...
$query = "SELECT per.id, p.namapasien, p.nik, p.tanggallahir, p.tempatlahir, p.jeniskelamin, p.alamat, p.domisili, p.desakelurahan,
          ...
          WHERE p.asalfasyankes = '$idpuskesmas'";  // Tambahkan kondisi ini
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($ambildatapasien)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <a href="periksahapus.php?id=<?php echo $id ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');" data-bs-toggle="tooltip" title="Hapus Data"><i class="fas fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
